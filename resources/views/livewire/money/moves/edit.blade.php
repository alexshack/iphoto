                ...
                <form class="form-horizontal" wire:submit.prevent="submit">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9" wire:ignore>
                            <select wire:model="moveData.city_id" data-pharaonic="select2" data-component-id="{{ $this->id  }}" class="form-control " data-placeholder="Выберите город">
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9" wire:ignore.self>
                                            <select id="payerPlace" data-pharaonic="select2" data-component-id="{{ $this->id  }}" data-placeholder="Выберите точку" wire:model="moveData.payer_id">
                            ...
                            <div class="tab-pane show {{ $moveData[App\Contracts\Money\MovesContract::FIELD_PAYER_TYPE] === 'manager' ? 'active' : '' }}" id="tab-2">
                                <div class="form-horizontal">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9" wire:ignore.self>
                                            <select id="payerManager" data-pharaonic="select2" data-component-id="{{ $this->id  }}" data-placeholder="Выберите менеджера" wire:model="moveData.payer_id">
                            ...
                            <div class="tab-pane {{ $moveData[App\Contracts\Money\MovesContract::FIELD_RECIPIENT_TYPE] === 'place' ? 'active' : '' }} show" id="tab-3">
                                <div class="form-horizontal">
                                    <div class="form-group row">
                                        <label class="form-label col-md-3">Точка</label>
                                        <div class="col-md-9" wire:ignore.self>
                                            <select id="recipientPlace" data-pharaonic="select2" data-component-id="{{ $this->id  }}" wire:model="moveData.recipient_id" data-placeholder="Выберите точку">
                                                <option label="Выберите точку"></option>
                                                @foreach($places as $place)
                            ...
                            <div class="tab-pane {{ $moveData[App\Contracts\Money\MovesContract::FIELD_RECIPIENT_TYPE] === 'manager' ? 'active' : '' }} show" id="tab-4">
                                <div class="form-horizontal">
                                    <div class="form-group row">
                                        <label class="form-label  col-md-3">Менеджер</label>
                                        <div class="col-md-9" wire:ignore.self>
                                            <select data-pharaonic="select2" data-component-id="{{ $this->id  }}" id="recipientManager" data-placeholder="Выберите менеджера"  wire:model="moveData.recipient_id">
                                                <option label="Выберите менеджера"></option>
                                                @foreach($managers as $manager)
                                                    <option value="{{ $manager->id }}">{{ $manager->getFullName() }}</option>
                                                @endforeach
