...
@section('content')
						...
						<div class="page-header d-xl-flex d-block">
							<div class="page-leftheader">
								<h4 class="page-title">Сотрудники<span class="font-weight-normal text-muted ml-2">Структура</span></h4>
							</div>
							<div class="page-rightheader ml-md-auto">
								<div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
									<div class="btn-list">
										<a href="{{url('structure/employees/add')}}" class="btn btn-primary mr-3">Добавить сотрудника</a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-xl-3 col-lg-6 col-md-12">
								<div class="card">
									<div class="card-body">
										<div class="row">
											<div class="col-7">
												<div class="mt-0 text-left"> <span class="font-weight-semibold">Всего сотрудников</span>
							...
							<div class="col-xl-3 col-lg-6 col-md-12">
								<div class="card">
									<div class="card-body">
										<div class="row">
											<div class="col-7">
												<div class="mt-0 text-left"> <span class="font-weight-semibold">Новые сотрудники</span>
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="table-responsive">
											<table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="employees-list">
												<thead>
													<tr>
														<th class="border-bottom-0 w-5">ID</th>
														<th class="border-bottom-0">Сотрудник</th>
														<th class="border-bottom-0">Город</th>
														<th class="border-bottom-0">Должность</th>
												...
												<tbody>
													<tr>
														...
														<td data-search="Сотрудник Сотрудников +79995554422" data-order="Сотрудников"><!-- Имя фамилия, телефон --><!-- Фамилия -->
															<div class="d-flex">
																...
																<div class="mr-3 mt-0 mt-sm-1 d-block">
																	<h6 class="mb-1 fs-14">
																		<a href="{{url('structure/employees/0')}}">Сотрудник Сотрудников</a>
																	</h6>
														...
														<td>
															<a class="btn btn-primary btn-icon btn-sm"  href="{{url('structure/employees/0')}}">
...
@section('scripts')
		...
		<!-- INTERNAL Index js-->
		<script src="{{URL::asset('assets/js/structure/employees.js')}}"></script>
