...
class CreateUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'user.' . UserContract::FIELD_EMAIL => [
                'email',
                'unique:' . UserContract::TABLE . ',' . UserContract::FIELD_EMAIL,
            ],
            'user.' . UserContract::FIELD_PHOTO => ['nullable', 'image', 'mimes:jpeg,jpg,webp', 'max:2048'],
            'user.' . UserContract::FIELD_PASSWORD => ['required', 'string', 'min:6', 'max:255'],
            'user.' . UserContract::FIELD_ROLE_ID => ['required', 'integer', 'in:1,2,3,4,5,6'],
    ...
    public function attributes()
    {
        return [
            ...
            'user.' . UserContract::FIELD_PASSWORD => 'Пароль',
